...
contract Fruits is ERC721Enumerable, Ownable, IExternallyMintable {
    ...
    function addMinter(address minter) external onlyOwner {
        if (options.mintersManipulationLocked) revert OptionLockedForever();
